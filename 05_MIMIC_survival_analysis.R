...
for (arg in args) {
  ...
  if (key %in% c(
    "input_file", "input_sheet", "posterior_file",
...
summary_filename <- "Table_S7_MIMIC_trajectory_summary.csv"
...
cox_filename <- "Table_S10_MIMIC_Cox_models.csv"
trajectory_names <- c(
  T1 = "Low-stable",
  T2 = "Early-rising",
  T3 = "Moderate-decreasing",
...
piecewise_filename <- "Table_S13_MIMIC_piecewise_Cox.csv"
...
rmst_filename <- "Table_S15_MIMIC_RMST.csv"
...
posterior_filename <- "Table_S17_MIMIC_high_posterior_subgroups.csv"
